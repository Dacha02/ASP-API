...
{
    public class ChangeCarValidator : AbstractValidator<ReceiveCarDtoWithCarId>
    {
        public ChangeCarValidator(CarRentalContext context)
        {
            RuleFor(x=> x.Id)
                .Cascade(CascadeMode.Stop)
                .NotEmpty().WithMessage("Car Id is required!")
                .Must(x => context.Cars.Any(y => y.Id == x)).WithMessage("Car id: {PropertyValue} doesn't exist");
